...
/*   Updated: 2023/03/24 21:45:15 by blopez-f         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	len = printf("[06] printf(\"[%%p][%%p][%%p][%%p]\", 0, 12, 2, ptr)    --> [%p][%p][%p][%p] ", 0, 12, 2, ptr);
	printf(" --> %i\n", len);
	len = ft_printf("[06] ft_printf(\"[%%p][%%p][%%p][%%p]\", 0, 12, 2, ptr) --> [%p][%p][%p][%p] ", 0, 12, 2, ptr);
	printf(" --> %i\n", len);
	free(ptr);
	ft_printf("---------------------------------------------------------------------\n");
